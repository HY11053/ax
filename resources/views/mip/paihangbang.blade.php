@extends('mip.mip')
@section('title'){{str_replace('加盟','',$thistypeinfo->typename)}}加盟排行榜_{{str_replace('加盟','',$thistypeinfo->typename)}}品牌排行榜-安心加盟网@stop
...
@section('description')安心加盟网为您全方位解读{{str_replace('加盟','',$thistypeinfo->typename)}}加盟品牌排行信息。分享{{str_replace('加盟','',$thistypeinfo->typename)}}门店信息，{{str_replace('加盟','',$thistypeinfo->typename)}}排行榜分类提供性价比最高{{str_replace('加盟','',$thistypeinfo->typename)}}品牌加盟排行榜信息，供你快速的选择适合自己的{{str_replace('加盟','',$thistypeinfo->typename)}}加盟品牌@stop
@section('headlibs')
            ...
            <div class="brand-detail-list-all">
                <div class="search-list-container  ">
                  ...
                  <span class="num-icon">
                    ...
                    <div class="clear"></div>
                    <a href="{{str_replace('www.','mip.',config('app.url'))}}/busInfo/{{$pagelist->id}}.html">
