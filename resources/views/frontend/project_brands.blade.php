...
@section('main_content')
    ...
    <div class="main">
        ...
        <div class="fenl_box">
            ...
            <div class="xuanze area_wrap">
                <strong>小行业：</strong>
                <ul>
                    <li @if(trim(Request::getrequesturi(),'/') == $thistypeinfo->real_path) class="dq" @endif ><a href="/canyin/">不限</a></li>
                    @foreach($sontypes as $sontype)
                        <li  @if(preg_replace('#\/[0-9_]+#','',trim(Request::getrequesturi(),'/')) == $sontype->real_path) class="dq" @endif><a href="/{{$sontype->real_path}}/">{{$sontype->typename}}</a></li>
                    @endforeach
                </ul>
                <a class="more_area_btn" id="js_more_area" href="javascript:;">展开</a>
            </div>
            <div class="xuanze clearfix">
                ...
                <ul>
                    ...
                    @foreach($type_investment_types as $investment_type)
                        @if(array_key_exists($investment_type->id,$investment_ids))
                            <li @if(str_contains(Request::getrequesturi(),$investment_type->url)) class="dq" @endif><a href="/{{$thistypeinfo->real_path}}/{{$investment_type->url}}/">{{$investment_type->type}}</a></li>
                        @endif
                    @endforeach
                </ul>
            ...
            <div class="xuanzea area_wrap1">
                <strong>加盟区域：</strong>
                <ul>
                    <li @if(trim(Request::getrequesturi(),'/') == $thistypeinfo->real_path) class="dq" @endif><a class="first" href="/{{$thistypeinfo->real_path}}/">全部</a></li>
                    @foreach($provinces as $provinces)
                        @if(array_key_exists($provinces->id,$province_ids))
                            <li @if(str_contains(Request::getrequesturi(),$provinces->name_path)) class="dq" @endif><a href="/{{$thistypeinfo->real_path}}/{{$provinces->name_path}}/{{$touzipath}}">{{$provinces->name_cn}}</a></li>
                        @endif
                    @endforeach
                </ul>
                ...
                <div class="white_bg">
                    ...
                    <div class="bd">
                        @foreach($pagelists as $pagelist)
                            <div class="bd_item">
                                <div class="item_pic">
                                    <a href="https://www.u88.com/xiangmu/{{$pagelist->id}}.html" target="_blank" title="{{$pagelist->brandname}}">
                                        <i>{{$loop->iteration}}</i><img src="{{$pagelist->litpic}}" alt="{{$pagelist->brandname}}">
                                    </a>
                                </div>
                                <div class="item_r">
                                    <p class="name">
                                        <a href="https://www.u88.com/xiangmu/{{$pagelist->id}}.html" target="_blank" title="{{$pagelist->brandname}}">{{$pagelist->brandname}}</a>
                                    </p>
                                ...
                                <div class="item_btn">
                                    <p class="btn">
                                        <a href="https://www.u88.com/xiangmu/{{$pagelist->id}}.html#msg">在线咨询</a>
                                    </p>
                                    <p class="btn_info">
                                        <a href="https://www.u88.com/xiangmu/{{$pagelist->id}}.html">了解详情&gt;</a>
                                    </p>
                                </div>
                            </div>
                        @endforeach
            ...
            <div class="new_right">
                ...
                <div class="hot_message hot_fl">
                    <div class="common_hd fl_tit">
                        <span class="more"><a href="/paihang/{{$thistypeinfo->real_path}}/" target="_blank">更多&gt;&gt;</a></span>
                        ...
                        <ul>
                            @foreach($paihangbangs as $paihangbang)
                                <li class=" top    @if($loop->first) hover @endif ">
                                    ...
                                    <span class="name">
								<a href="https://www.u88.com/xiangmu/{{$paihangbang->id}}.html" target="_blank" title="{{$paihangbang->brandname}}">{{$paihangbang->brandname}}</a>
							</span>
                                    <div class="cts">
                                        <div class="img">
                                        ...
                                        <div class="center">
                                            ...
                                            <p class="btn">
                                                <a href="https://www.u88.com/xiangmu/{{$paihangbang->id}}.html#msg">立即咨询</a>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                ...
                <div class="bd_commit">
                    ...
                    <div class="bd_list">
                        @foreach($latestbrands as $latestbrand)
                            <dl>
                                <dt>
                                    <a href="https://www.u88.com/xiangmu/{{$latestbrand->id}}.html" target="_blank">
                                        <img src="{{$latestbrand->litpic}}" alt="{{$latestbrand->brandname}}" title="{{$latestbrand->brandname}}">
                                    </a>
                                </dt>
                                <dd class="tit">
                                    <a href="https://www.u88.com/xiangmu/{{$latestbrand->id}}.html" target="_blank" title="{{$latestbrand->brandname}}">{{$latestbrand->brandname}}</a>
                                </dd>
                                <dd>投资额度：
                                    <em>{{$investment_types[$latestbrand->tzid]}}</em>
                                </dd>
                                <p>
                                    <a href="https://www.u88.com/xiangmu/{{$latestbrand->id}}.html">立即咨询</a>
                                </p>
                            </dl>
                        @endforeach
                    </div>
                    ...
                    <div class="bd">
                        <ul>
                            @foreach($newbrands as $newbrand)
                                <li>
                                    <a href="https://www.u88.com/xiangmu/{{$newbrand->id}}.html">{{$newbrand->brandname}}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
