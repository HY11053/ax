                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($articles as $article)
                            <tr>
                                ...
                                <td class="astyle"><span class="label label-success"><a href="/xiangmu/{{$article->id}}.html" target="_blank">预览</a></span><span class="label label-warning"><a href="/admin/article/brandedit/{{$article->id}}">编辑</a></span><span class="label label-danger"><a data-toggle="modal" data-target=".modal-sm{{$article->id}}" >删除</a></span>
