                    ...
                    @if($index<5)
                        <li>
                            <a href="/article/{{$chuangyeg->id}}.html">
                                <div class="img_show"><img src="{{$chuangyeg->litpic}}" alt="{{$chuangyeg->title}}"></div>
                                <div class="cont">
                    ...
                    @if($index<5)
                        <li>
                            <a href="/article/{{$jmfeiyong->id}}.html">
                                <div class="img_show"><img src="{{$jmfeiyong->litpic}}" alt="{{$jmfeiyong->title}}"></div>
                                <div class="cont">
                    ...
                    @if($index<5)
                        <li>
                            <a href="/article/{{$chuanyezd->id}}.html">
                                <div class="img_show"><img src="{{$chuanyezd->litpic}}" alt="{{$chuanyezd->title}}"></div>
                                <div class="cont">
                    ...
                    @if($index<5)
                        <li>
                            <a href="/article/{{$brandnew->id}}.html">
                                <div class="img_show"><img src="{{$brandnew->litpic}}" alt="{{$brandnew->title}}"></div>
                                <div class="cont">
