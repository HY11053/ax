...
@section('main_content')
    ...
    <div class="news_cont">
        ...
        <div class="wz_pp">
            <span><a href="/xiangmu/{{$thisarticlebrandinfos->id}}.html"><img src="{{$thisarticlebrandinfos->litpic}}"></a></span>
                    ...
                    @if($index<4)
                        <li>
                            <a href="/article/{{$latestbrandnew->id}}.html">
                                <div class="img_show"><img src="{{$latestbrandnew->litpic}}" alt="{{$latestbrandnew->title}}" /></div>
                                <div class="cont">
    ...
    <div class="rec_item">
        <div class="common_tit">
            ...
            <a class="tit" href="/xiangmu/"><i class="index_icon1"></i>项目推荐</a>
        </div>
        <div class="bd">
            <ul>
