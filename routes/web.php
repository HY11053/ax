...
Route::get('xiangmu/p{page}','Frontend\XiangmuProjectController@XiangmuLists')->where('path','[a-zA-Z0-9]+')->name('xiangmulist2');
Route::get('xiangmu/{tid}_{zid?}','Frontend\XiangmuProjectController@projectBrandLists')->where(['path'=>'[a-zA-Z0-9]+','tid'=>'[0-9]+','zid'=>'[0-9]+'])->name('projectlists');
Route::get('xiangmu/{tid}_{zid?}/p{page}','Frontend\XiangmuProjectController@projectBrandLists')->where(['path'=>'[a-zA-Z0-9]+','tid'=>'[0-9]+','zid'=>'[0-9]+'])->name('projectlists2');
Route::get('xiangmu/{path2}/{tid}_{zid?}','Frontend\XiangmuProjectController@CityInverBrandLists')->where(['path'=>'[a-zA-Z]+','path2'=>'[a-zA-Z_]+','tid'=>'[0-9]+','zid'=>'[0-9]+'])->name('xmcitypagelist2');
Route::get('xiangmu/{path2}/{tid}_{zid?}/p{page}','Frontend\XiangmuProjectController@CityInverBrandLists')->where(['path'=>'[a-zA-Z]+','path2'=>'[a-zA-Z_]+','tid'=>'[0-9]+','zid'=>'[0-9]+'])->name('xmcitypagelist2');
Route::get('xiangmu/{path2}','Frontend\XiangmuProjectController@CityBrandLists')->where(['path2'=>'[a-zA-Z_]+'])->name('xmcitypagelist');
Route::get('xiangmu/{path2}/p{page}','Frontend\XiangmuProjectController@CityBrandLists')->where(['path2'=>'[a-zA-Z_]+'])->name('xmcitypagelist2');
Route::get('paihang','Frontend\PaihangbangController@IndexPaihangbang');
Route::get('paihang/all','Frontend\PaihangbangController@PaihangbangAll');
Route::get('paihang/month','Frontend\PaihangbangController@PaihangbangMonth');
Route::get('paihang/week','Frontend\PaihangbangController@PaihangbangWeek');
Route::get('paihang/{path}','Frontend\PaihangbangController@Paihangbang')->where('path', '[a-zA-Z_0-9]+');
...
Route::get('{path}/{path2}/{tid}_{zid?}/p{page}','Frontend\ArticleCategorizationController@CityInverBrandLists')->where(['path'=>'[a-zA-Z_]+','path2'=>'[a-zA-Z_]+','tid'=>'[0-9]+','zid'=>'[0-9]+'])->name('citypagelist2');
