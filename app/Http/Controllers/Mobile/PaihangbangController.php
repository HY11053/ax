...
class PaihangbangController extends Controller
{
    public function IndexPaihangbang()
    {
        ...
        return view('mobile.paihangbang_index',compact('topbandnavs','topbandnav2','paihangbangbrands','investment_types','paihangbangalls','paihangbangmonths','paihangbangweeks'));
    }
    ...
    public function Paihangbang($path='')
    {
        ...
        return view('mobile.paihangbang',compact('thistypeinfo','paihangbrands','investment_types','navbrands','navtops'));
    }
    ...
    public function PaihangbangAll($path='')
    {
        ...
        return view('mobile.paihangbang_all',compact('thistypeinfo','paihangbrands','investment_types','navbrands','navtops'));
    }
    ...
    public function PaihangbangMonth($path='')
    {
        ...
        return view('mobile.paihangbang_month',compact('thistypeinfo','paihangbrands','investment_types','navbrands','navtops'));
    }
    ...
    public function PaihangbangWeek($path='')
    {
        ...
        return view('mobile.paihangbang_week',compact('thistypeinfo','paihangbrands','investment_types','navbrands','navtops'));
    }
}
