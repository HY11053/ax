...
class PaihangbangController extends Controller
{
    public function IndexPaihangbang()
    {
        ...
        return view('frontend.paihangbang_index',compact('topbandnavs','topbandnav2','paihangbangbrands','investment_types','paihangbangalls','paihangbangmonths','paihangbangweeks'));
    }
    ...
    public function Paihangbang($path='')
    {
        ...
        return view('frontend.paihangbang',compact('thistypeinfo','paihangbrands','investment_types','navbrands','navtops'));
    }
    ...
    public function PaihangbangAll($path='')
    {
        ...
        return view('frontend.paihangbang_all',compact('thistypeinfo','paihangbrands','investment_types','navbrands','navtops'));
    }
    ...
    public function PaihangbangMonth($path='')
    {
        ...
        return view('frontend.paihangbang_month',compact('thistypeinfo','paihangbrands','investment_types','navbrands','navtops'));
    }
    ...
    public function PaihangbangWeek($path='')
    {
        ...
        return view('frontend.paihangbang_week',compact('thistypeinfo','paihangbrands','investment_types','navbrands','navtops'));
    }
}
