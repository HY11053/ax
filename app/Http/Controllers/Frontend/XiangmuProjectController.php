...
class XiangmuProjectController extends Controller
{
    ...
    public function XiangmuLists(Request $request,$page=0)
    {
        ...
        return view('frontend.xiangmu_project',compact('thistypeinfo','topbrandtypeinfos','sontypes','pagelists','paihangbangs','investment_types','latestbrands','latestbrandnews','flinks','provinces','province_ids','thistypeinforeid','investment_ids','type_investment_types','newbrands','touzipath'));
    }
    /***
     * 品牌分类筛选
     * @param Request $request
    ...
    public function projectBrandLists($tid='',$zid='',$page=0)
    {
        ...
        return view('frontend.xiangmu_project',compact('thistypeinfo','topbrandtypeinfos','sontypes','pagelists','paihangbangs','investment_types','latestbrands','latestbrandnews','flinks','provinces','province_ids','thistypeinforeid','investment_ids','type_investment_types','newbrands','touzipath','project_title'));
    }
