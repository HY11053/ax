...
class ArticleController extends Controller
{
    ...
    public function NewsArticle(Request $request,$id)
    {
        ...
        return view('mip.article_article',compact('thisarticleinfos','thisarticlebrandinfos','prev_article','next_article','latestbrandnews','paihangbangs','latesttypenews','latestbrands','thistypeinfo','thisbrandtypeinfo','thisbrandtypecidinfo','investment_types','brand','thisarticlebradarea'));
    }
    ...
    public function BrandArticle($id)
    {
        ...
        return view('mip.brand_article',compact('thisarticleinfos','thisbrandtypeinfo','thisbrandtypecidinfo','thisarticlebradarea','investment_types','paihangbangs','latestbrandnews','latesttypenews','latestbrands','newbrands','brandtypeids'));
    }
