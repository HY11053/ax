...
class ArticleCategorizationController extends Controller
{
    ...
    public function listNews(Request $request,$path,$page=0)
    {
        ...
        if($thistypeinfo->mid==0)
        {
            ...
            return view('mip.list_article',compact('thistypeinfo','pagelists','paihangbangs','investment_types','latestbrands','hotbrandnews','toparticlenavs'));
        }else{
            //品牌列表页
            //获取品牌顶级栏目分类并缓存
            ...
            return view('mip.brands',compact('thistypeinfo','topbrandtypeinfos','sontypes','pagelists','paihangbangs','investment_types','latestbrands','latestbrandnews','flinks','provinces','province_ids','thistypeinforeid','investment_ids','type_investment_types','newbrands'));
        }
    ...
    public function articleIndex()
    {
        ...
        return view('mip.article_index',compact('hotnews','chuangyeasks','chuangyemiddleasks','chuangyemidbottomasks','newsphs',
